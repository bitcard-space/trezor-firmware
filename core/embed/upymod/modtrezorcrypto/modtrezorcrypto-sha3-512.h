...
STATIC mp_obj_t mod_trezorcrypto_Sha3_512_make_new(const mp_obj_type_t *type,
  ...
  mp_obj_Sha3_512_t *o = ((mp_obj_Sha3_512_t *)(m_malloc_with_finaliser(sizeof(mp_obj_Sha3_512_t))));
...
STATIC mp_obj_t mod_trezorcrypto_Sha3_512_copy(size_t n_args,
  ...
  mp_obj_Sha3_512_t *out = ((mp_obj_Sha3_512_t *)(m_malloc_with_finaliser(sizeof(mp_obj_Sha3_512_t))));
